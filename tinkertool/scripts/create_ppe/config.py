...
class CheckedCreatePPEConfig(CreatePPEConfig):
    ...
    simulation_setup:       configparser.ConfigParser = field(default=None, metadata={"help": "Parsed simulation setup file"})
    # - ppe_settings
    baseroot:               Path = field(default=None, metadata={"help": "Path to the base case root directory"})
    ...
    num_vars:               int = field(default=None, metadata={"help": "Number of variables in the paramfile"})
    ensemble_num:           np.ndarray = field(default=None, metadata={"help": "Ensemble number in the paramfile"})
    # - namelist_control
    namelist_collection_dict: dict = field(default=None, metadata={"help": "Dictionary of namelist parsed namelist_control files"})
    # - create_case
    cesmroot:              Path = field(default=None, metadata={"help": "Path to the CESM root directory"})
...
class SubmitPPEConfig(BaseConfig):
    cases:  Union[str, Path, list[str], list[Path]] = field(default=None, metadata={"help": "List of case directories to submit to the queue"})
