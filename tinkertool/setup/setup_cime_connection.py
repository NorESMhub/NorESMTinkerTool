...
def add_CIME_paths(cesmroot: str) -> None:
...
def add_CIME_paths_and_import(cesmroot: str) -> None:
    ...
    try:
        ...
        print(
            f"ERROR: CIME not found in {cesmroot}, update CESMROOT environment variable"
        )
